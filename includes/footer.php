<footer class="site-footer">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                        <div class="footer-widget">
                            <a href="index.php" class="footer-widget__Logo">
                                <img src="assets/logo/white-logo.png" width="153" alt="">
                            </a>
                            <p>
                            Ikonic LTD is a Kenyan Company Dealing with Supply of Modern Farm Machinery as well as Creating Awareness on the Importance of Mechanized Farming.
                            </p>
        ...
        <div class="bottom-footer">
            <div class="container">
                <p>© Copyright 2021 by Ikonic Agricultural Machinery</p>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index.html" aria-label="logo image"><img src="assets/logo/white-logo.png" width="155" alt="" /></a>
            </div>
            <!-- /.logo-box -->
            ...
            <div class="mobile-nav__top">
                ...
                <div class="mobile-nav__social">
                    ...
                    <a href="https://www.facebook.com/www.ikonicltd.co.ke/" target="_blank" aria-label="facebook"><i class="fab fa-facebook-square"></i></a>
